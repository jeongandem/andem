...
<section>
	<div class="row">
		<div class="col-sm-offset-2">
			...
			<form id="qnafrm" class="form-horizontal" name="qwfrm" method="post"
				action="${pageContext.request.contextPath }/board/qnaWrite.do">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<textarea id="content" class="form-control" rows="8" cols=""
				...
				<div class="text-center">
					<div class="col-sm-offset-2 col-sm-5">
						<input id="submit" type="submit" value="등록"
							...
							class="btn btn-danger"> <a class="btn btn-success"
							href="${pageContext.request.contextPath }/board/qna.do">글 목록</a>
					</div>
				</div>
			</form>
		</div>
